...
function renderIngredientsBoard(){
  ...
  if(!state.Tomatoes){
    document.getElementById('tomatoes1').style.display='none'
  }
  else{
    document.getElementById('tomatoes1').style.display='block'
  }
  if(!state.Onions){
    document.getElementById('onions1').style.display='none'
  }
  else{
    document.getElementById('onions1').style.display='block'
  }
  if(!state.Lettuce){
